...
int main() {
    ...
    // Command buffer 录制
    auto recordCommandBuffer = [commandBuffer, renderPass, swapChainFramebuffers, swapChainExtent, graphicsPipeline](uint32_t imageIndex) {
    ...
    auto drawFrame = [device, swapChain, imageAvailableSemaphore, inFlightFence, recordCommandBuffer]() {
