...
//  ImTextureID! [X] Renderer: Large meshes support (64k+ vertices) with 16-bit indices. [X]
...
void ImGui_ImplMetal_RenderDrawData(ImDrawData* draw_data, MTL::CommandBuffer* commandBuffer,
    ...
    ImGui_ImplMetal_RenderDrawData(draw_data, (id<MTLCommandBuffer>)(commandBuffer),
...
bool ImGui_ImplMetal_Init(id<MTLDevice> device) {
    ...
    if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable) ImGui_ImplMetal_InitPlatformInterface();
...
static void ImGui_ImplMetal_CreateWindow(ImGuiViewport* viewport) {
    ...
    // PlatformHandleRaw NULL, in which case we assume PlatformHandle will contain the NSWindow*.
    void* handle =
...
static void ImGui_ImplMetal_ShutdownPlatformInterface() { ImGui::DestroyPlatformWindows(); }
