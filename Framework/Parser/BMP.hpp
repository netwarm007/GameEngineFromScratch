...
#pragma pack(pop)
    ...
    public:
        ...
        {
            Image img;
            BITMAP_FILEHEADER* pFileHeader = reinterpret_cast<BITMAP_FILEHEADER*>(buf.GetData());
            BITMAP_HEADER* pBmpHeader = reinterpret_cast<BITMAP_HEADER*>(buf.GetData()+ BITMAP_FILEHEADER_SIZE);
