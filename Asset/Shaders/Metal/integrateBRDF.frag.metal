...
struct integrateBRDF_frag_main_out
{
    float2 FragColor [[color(0)]];
};

struct integrateBRDF_frag_main_in
{
...
fragment integrateBRDF_frag_main_out integrateBRDF_frag_main(integrateBRDF_frag_main_in in [[stage_in]])
{
    integrateBRDF_frag_main_out out = {};
    float param = in.UV.x;
