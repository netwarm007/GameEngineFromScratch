...
cmake -DCMAKE_INSTALL_PREFIX=$INSTALL_ROOT -DCMAKE_BUILD_TYPE=Release -DARM_ENABLED=ON -DNVPTX_ENABLED=OFF -DISPC_INCLUDE_EXAMPLES=OFF -DBISON_EXECUTABLE=$INSTALL_ROOT/bin/bison $ISPC_HOME
make -j4
make install
