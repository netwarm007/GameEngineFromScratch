/*
    ...
    GLX loader generated by glad 0.1.14a0 on 10/12/17 14:02:52.
...
static void load_GLX_MESA_swap_control(GLADloadproc load) {
    ...
    glad_glXGetSwapIntervalMESA =
        (PFNGLXGETSWAPINTERVALMESAPROC)load("glXGetSwapIntervalMESA");
    glad_glXSwapIntervalMESA =
        (PFNGLXSWAPINTERVALMESAPROC)load("glXSwapIntervalMESA");
}
